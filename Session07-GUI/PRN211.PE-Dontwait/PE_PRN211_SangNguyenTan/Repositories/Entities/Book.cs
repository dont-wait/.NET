...
namespace Repositories.Entities
{
    public class Book
    {
        ...
        //ENTITIES CLASS MAP TRỰC TIẾP XUỐNG TABLE
        ...
        //2. STYLE DATABASE FIRST: KO CẦN GÕ CLASS NÀY, DÙNG OR - MAPPING
        //FRAMEWORK HIBERNATE, EF CORE SUY NGƯỢC TỪ TABLE RA CLASS - ENTITY
        
        //BÀI THI PE, MÌNH DÙNG STYLE 2 - TỨC LÀ CÓ SẴN DB.SQL => SUY RA
        //THỨ 6 SẼ CÓ - CẮM VẮNG MẶT
