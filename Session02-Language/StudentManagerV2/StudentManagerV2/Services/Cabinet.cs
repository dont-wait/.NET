using StudentManagerV2.Enities;
using System;
...
namespace StudentManagerV2.Services
{
    ...
    { //tương tự Cái Tủ đựng hồ sơ ngoài đời
        ...
        //Mở ngăn tủ, nhét 1 bộ hồ sơ vào
        //Mở ngăn tủ, tìm lấy ra 1 bộ, chỉnh sửa thêm ảnh, giấy A4 ghi chú, cất trở lại
        //Mở ngăn tủ, "chôm" làm biến mất 1 bộ hồ sơ đang có: DELETE/REMOVE
        //Mở ngăn tủ, tìm 1 bộ hồ sơ, thấy rồi, sao chụp lại, rồi cất vào chỗ cũ: SEARCH, 
        //READ/RETRIEVE ONE
        //Mở ngăn tủ, sắp xếp cho gọn gàng theo tiêu chí: ngày tháng năm, tên (nghi phạm):
        //SORT/RETRIEVE
        ...
        //tại sao _list nghĩa là baking field mà ko chơi property/ẩn backing,
        //chỉ Get() Set()
        //public Student[] Students { get; set; } 
        //.Students = ??? 300 bộ hồ sơ, ko hợp lí nếu bị phải làm: nhét 1 lúc 300 bộ hồ sơ
        //, vài trăm hồ sơ, do prop của Tủ là mảng hồ sơ, khi Set() phải là Set() mảng
        //int Yob của SV là Set lẻ 1 giá trị 
        //prop mảng thì Set() mảng, prop lẻ thì Set() lẻ
        //QUAY VỀ TRUYỀN THỐNG, CLASSS CÓ 1 MẢNG, TỦ CÓ 1 KHÔNG GIAN RỖNG, VÀ TỪ TỪ NHÉT VÔ
        ...
        //CÒN CÁI VIỆC NHẬP THÔNG TIN HỒ SƠ TRƯỚC KHI CẤT VÀO TỦ, ĐÓ LÀ VIỆC CỦA CHỖ KHÁC, CLASS KHÁC
        ...
        //GẮN NHẬP VÀO HÀM NÀY KO OKIE, KO GIÚP APP TRỞ NÊN DẼ BOẢ TRÌ, NÂNG CAOAS, FLEXIBLE
        ...
        {
            Console.WriteLine($"There is/are student(s) {_count} in the cabinet");
...
//IN RA DANH SÁCH SINH VIÊN SẮP XẾP THEO THỨ TỰ TĂNG DẦN CẢU TÊN A - Z
